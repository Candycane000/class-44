var bg,bg_image,man,man_image, thief, thief_image, coin, coin_image, rock, rock_image, ground, bullet, bullet_image;
var score;
function preload(){
...
function setup() {
  ...
  man.debug=true
  man.setCollider("rectangle",0,0,150,300)
  ground=createSprite(100,920,2000,10)
